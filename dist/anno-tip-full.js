(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.AnnoTip = factory(global.$));
  ...
  var build = createCommonjsModule(function (module, exports) {
    !function (t, n) {
      ...
      return function (t) {
        ...
        function o(t, n, r) {
          Array.isArray(t) ? t.push(n) : t[r] = n;
        }
        ...
        function i(t) {
          var n = t.parentNode;
          if (n) for (var r = 0, e = n.childNodes, i = 0; i < e.length; i++) {
            if (o(e[i]) && (r += 1, e[i] === t)) return [":nth-child(".concat(r, ")")];
          }
          return [];
        }
        ...
        function g() {
          ...
          var n = t.map(function (t) {
            return "string" == typeof t ? v(t) : t.source;
          }).join("|");
          return new RegExp(n);
        }
        ...
        function h(t, n) {
          var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : document,
              e = r.querySelectorAll(n);
          return 1 === e.length && e[0] === t;
        }

        function b(t) {
          for (var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : m(t), r = [], e = t; o(e) && e !== n;) {
        ...
        function j(t) {
          return [N(t.tagName.toLowerCase())];
        }
        ...
        var E = ":".charCodeAt(0).toString(16).toUpperCase(),
            T = /[ !"#$%&'()\[\]{|}<>*+,./;=?@^`~\\]/;

        function N() {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
          return t.split("").map(function (t) {
            return ":" === t ? "\\".concat(E, " ") : T.test(t) ? "\\".concat(t) : escape(t).replace(/%/g, "\\");
          }).join("");
        }
        ...
        var C = {
          ...
          id: function id(t) {
            var n = t.getAttribute("id") || "",
                r = "#".concat(N(n));
            return !a.test(n) && h(t, r, t.ownerDocument) ? [r] : [];
          },
          ...
          attribute: function attribute(t) {
            return A(t.attributes).filter(O).map(S);
          },
          nthchild: i,
          nthoftype: function nthoftype(t) {
            var n = j(t)[0],
                r = t.parentElement;
            if (r) for (var e = r.querySelectorAll(n), o = 0; o < e.length; o++) {
              if (e[o] === t) return ["".concat(n, ":nth-of-type(").concat(o + 1, ")")];
            }
            return [];
          }
        };
        ...
        function P(t, n) {
          if (t.parentNode) for (var r = function (t, n) {
            return function (t) {
              var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                  r = n.selectors,
                  e = n.combineBetweenSelectors,
                  o = n.includeTag,
                  i = e ? y(r) : r.map(function (t) {
                return [t];
              });
              return o ? i.map(_) : i;
            }(t, n).map(function (n) {
              return r = t, e = {}, n.forEach(function (t) {
                var n = r[t];
                n.length > 0 && (e[t] = n);
              }), p()(e).map(q);
              var r, e;
            ...
            return function (t) {
              ...
              return n[r] = o ? y(e) : e.map(function (t) {
                return [t];
              }), n;
            }, {});
          }(t, n), n), e = (u = r, (c = []).concat.apply(c, d(u))), o = 0; o < e.length; o++) {
            var i = e[o];
            if (h(t, i, t.parentNode)) return i;
          }
          var u, c;
          return "*";
        }
        ...
        function _(t) {
          return t.includes("tag") || t.includes("nthoftype") ? x(t) : [].concat(x(t), ["tag"]);
        }
        ...
        function R(t) {
          for (var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = M(t, n), e = b(t, r.root), o = [], i = 0; i < e.length; i++) {
            o.unshift(P(e[i], r));
            var u = o.join(" > ");
            if (h(t, u, r.root)) return u;
          }

          return D(t, r.root);
        }

        r.d(n, "getCssSelector", function () {
          return R;
        });
        n["default"] = R;
      }]);
  ...
  */
  ...
  AnnoTip.prototype._handleSelection = function (selRoot, selection) {
    ...
    var anno = new Anno({
      ...
      element: theEl,
      root: selRoot,
      reverseSelector: this.settings.cssReverseOptions !== false ? CssSelectorGenerator(theEl, $__default['default'].extend({
